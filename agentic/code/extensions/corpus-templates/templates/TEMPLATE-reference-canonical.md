...
- **Quality**: {A / A- / B / C / D — with brief rationale referencing the GRADE scheme in CLAUDE.md}
...
(If no AIWG implementation relevance, replace this section with a "Cross-corpus relevance" note describing how this paper connects to broader research lineages tracked in the corpus.)
