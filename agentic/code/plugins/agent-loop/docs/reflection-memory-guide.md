...
npx ajv validate \
  -s ${CLAUDE_PLUGIN_ROOT}/schemas/reflection-memory.json \
...
```typescript
import Ajv from 'ajv';
import schema from '@/${CLAUDE_PLUGIN_ROOT}/schemas/reflection-memory.json';
...
- **@$AIWG_ROOT/${CLAUDE_PLUGIN_ROOT}/schemas/reflection-memory.json** - JSON Schema definition
