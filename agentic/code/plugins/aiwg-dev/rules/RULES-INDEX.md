...
**Full rule**: @$AIWG_ROOT/${CLAUDE_PLUGIN_ROOT}/rules/aiwg-ci-safety.md
...
**Full rule**: @$AIWG_ROOT/${CLAUDE_PLUGIN_ROOT}/rules/skill-placement.md
...
**Full rule**: @$AIWG_ROOT/${CLAUDE_PLUGIN_ROOT}/rules/no-circular-skill-calls.md
...
**Full rule**: @$AIWG_ROOT/${CLAUDE_PLUGIN_ROOT}/rules/component-completeness.md
...
**Full rule**: @$AIWG_ROOT/${CLAUDE_PLUGIN_ROOT}/rules/addon-boundaries.md
...
**Full rule**: @$AIWG_ROOT/${CLAUDE_PLUGIN_ROOT}/rules/aiwg-dir-reference-contract.md
