# RLM Agent Worked-Examples Catalog

Discoverable home for the few-shot worked examples that used to live inline in
the RLM addon's agent definitions. Externalizing them keeps agent definitions
...
aiwg discover "rlm agent worked examples catalog"
...
- #1600 — debloat RLM agent + remaining oversized SDLC agents
