...
|---|---|
| Package | `chalk` |
| Canonical upstream repository | https://github.com/chalk/chalk.git |
| Audited version/ref | `4.1.2` / `4.1.2` |
| npm registry signatures | 1 |
| Dependency source summary | `ansi-styles`, `supports-color` |
| Optional dependency summary | (none) |
| Peer dependency summary | (none) |
| Provenance record path | `.aiwg/security/supply-chain/external-npm/chalk.md` |

## AIWG Usage Contexts

| Manifest | Field | Spec | Lockfile Version | Integrity | Install Script | Optional Lock Entry | Tracking |
|---|---|---:|---:|---|---|---|---|
| `package.json` | `dependencies` | `^4.1.2` | `4.1.2` | yes | no | no | #1444 |

## Lockfile Tarballs

- package.json: https://registry.npmjs.org/chalk/-/chalk-4.1.2.tgz
