...
|---|---|
| Package | `commander` |
| Canonical upstream repository | https://github.com/tj/commander.js.git |
| Audited version/ref | `12.1.0` / `970ecae402b253de691e6a9066fea22f38fe7431` |
| npm registry signatures | 1 |
| Dependency source summary | (none) |
| Optional dependency summary | (none) |
| Peer dependency summary | (none) |
| Provenance record path | `.aiwg/security/supply-chain/external-npm/commander.md` |

## AIWG Usage Contexts

| Manifest | Field | Spec | Lockfile Version | Integrity | Install Script | Optional Lock Entry | Tracking |
|---|---|---:|---:|---|---|---|---|
| `package.json` | `dependencies` | `^12.1.0` | `12.1.0` | yes | no | no | #1444 |
| `tools/eval/package.json` | `dependencies` | `^12.1.0` | `12.1.0` | yes | no | no | #1447 |

## Lockfile Tarballs

- package.json: https://registry.npmjs.org/commander/-/commander-12.1.0.tgz
- tools/eval/package.json: https://registry.npmjs.org/commander/-/commander-12.1.0.tgz
