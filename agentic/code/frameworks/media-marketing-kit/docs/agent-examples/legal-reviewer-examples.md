# Legal Reviewer — Worked Examples

Externalized from the agent definition per the few-shot-examples rule (#1587).

These are the full legal-review templates, regulatory reference tables,
specific-review templates, and disclaimer templates that back the Legal
Reviewer. The agent definition keeps the process, the risk-scoring matrix and
risk-response gate, and a single compact inline anchor; the full templates and
