# Container Analyst — Detection Playbook
...
The agent definition keeps the enumerated detection targets, escape-vector criteria, and gates inline. This file carries the exact command sequences per runtime/tool.
