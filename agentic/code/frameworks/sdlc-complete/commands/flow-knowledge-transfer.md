...
argument-hint: <from-member> <to-member> [domain]
...
The Knowledge Transfer flow ensures continuity when team members transition roles, leave projects, or hand off domain expertise through structured observation, practice, and validation.
