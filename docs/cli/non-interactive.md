...
stable_id: aiwg.agent-reference.non-interactive-install
---

# Non-Interactive Installation

> **Audience: agents, provisioning scripts, and CI maintainers.** Workstation
> users should follow
...
- [CLI Reference](https://github.com/jmagly/aiwg/blob/main/docs/cli/reference.md) — Full command documentation
