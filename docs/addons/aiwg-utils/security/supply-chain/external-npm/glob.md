...
|---|---|
| Package | `glob` |
| Canonical upstream repository | https://github.com/isaacs/node-glob.git |
| Audited version/ref | `13.0.1` / `13.0.1` |
| npm registry signatures | 1 |
| Dependency source summary | `minimatch`, `path-scurry` |
| Optional dependency summary | (none) |
| Peer dependency summary | (none) |
| Provenance record path | `.aiwg/security/supply-chain/external-npm/glob.md` |

## AIWG Usage Contexts

| Manifest | Field | Spec | Lockfile Version | Integrity | Install Script | Optional Lock Entry | Tracking |
|---|---|---:|---:|---|---|---|---|
| `package.json` | `dependencies` | `^13.0.1` | `13.0.1` | yes | no | no | #1444 |

## Lockfile Tarballs

- package.json: https://registry.npmjs.org/glob/-/glob-13.0.1.tgz
...
| Script | Command |
|---|---|
| `prepublishOnly` | `template-oss checks` |
| `prepare` | `build` |
