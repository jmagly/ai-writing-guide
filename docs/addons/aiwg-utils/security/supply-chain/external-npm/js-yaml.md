...
|---|---|
| Package | `js-yaml` |
| Canonical upstream repository | https://github.com/nodeca/js-yaml.git |
| Audited version/ref | `4.1.1` / `4.1.1` |
| npm registry signatures | 1 |
| Dependency source summary | `argparse` |
| Optional dependency summary | (none) |
| Peer dependency summary | (none) |
| Provenance record path | `.aiwg/security/supply-chain/external-npm/js-yaml.md` |

## AIWG Usage Contexts

| Manifest | Field | Spec | Lockfile Version | Integrity | Install Script | Optional Lock Entry | Tracking |
|---|---|---:|---:|---|---|---|---|
| `package.json` | `dependencies` | `^4.1.0` | `4.1.1` | yes | no | no | #1444 |
| `tools/eval/package.json` | `dependencies` | `^4.1.0` | `4.1.1` | yes | no | no | #1447 |

## Lockfile Tarballs

- package.json: https://registry.npmjs.org/js-yaml/-/js-yaml-4.1.1.tgz
- tools/eval/package.json: https://registry.npmjs.org/js-yaml/-/js-yaml-4.1.1.tgz
