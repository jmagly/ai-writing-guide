...
|---|---|
| Package | `graceful-fs` |
| Canonical upstream repository | https://github.com/isaacs/node-graceful-fs.git |
| Audited version/ref | `4.2.11` / `4.2.11` |
| npm registry signatures | 1 |
| Dependency source summary | (none) |
| Optional dependency summary | (none) |
| Peer dependency summary | (none) |
| Provenance record path | `.aiwg/security/supply-chain/external-npm/graceful-fs.md` |

## AIWG Usage Contexts

| Manifest | Field | Spec | Lockfile Version | Integrity | Install Script | Optional Lock Entry | Tracking |
|---|---|---:|---:|---|---|---|---|
| `package.json` | `dependencies` | `^4.2.11` | `4.2.11` | yes | no | no | #1444 |

## Lockfile Tarballs

- package.json: https://registry.npmjs.org/graceful-fs/-/graceful-fs-4.2.11.tgz
