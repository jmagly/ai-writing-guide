...
|---|---|
| Package | `chokidar` |
| Canonical upstream repository | https://github.com/paulmillr/chokidar.git |
| Audited version/ref | `3.6.0` / `3.6.0` |
| npm registry signatures | 1 |
| Dependency source summary | `anymatch`, `braces`, `fsevents (optional)` |
| Optional dependency summary | (none) |
| Peer dependency summary | (none) |
| Provenance record path | `.aiwg/security/supply-chain/external-npm/chokidar.md` |

## AIWG Usage Contexts

| Manifest | Field | Spec | Lockfile Version | Integrity | Install Script | Optional Lock Entry | Tracking |
|---|---|---:|---:|---|---|---|---|
| `package.json` | `dependencies` | `^3.6.0` | `3.6.0` | yes | no | no | #1444 |

## Lockfile Tarballs

- package.json: https://registry.npmjs.org/chokidar/-/chokidar-3.6.0.tgz
