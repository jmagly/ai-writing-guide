# tsx External NPM Supply-Chain Audit
...
|---|---|
| Package | `tsx` |
| Canonical upstream repository | https://github.com/privatenumber/tsx.git |
| Audited version/ref | `4.21.0` / `f6284cd50575ce6e8d110f63266d66cb9cde3b88` |
| npm registry signatures | 1 |
| Dependency source summary | `esbuild`, `get-tsconfig` |
| Optional dependency summary | `fsevents` |
| Peer dependency summary | (none) |
| Provenance record path | `.aiwg/security/supply-chain/external-npm/tsx.md` |

## AIWG Usage Contexts

| Manifest | Field | Spec | Lockfile Version | Integrity | Install Script | Optional Lock Entry | Tracking |
|---|---|---:|---:|---|---|---|---|
| `package.json` | `devDependencies` | `^4.21.0` | `4.21.0` | yes | no | no | #1446 |
| `tools/eval/package.json` | `devDependencies` | `^4.7.0` | `4.21.0` | yes | no | no | #1447 |

## Lockfile Tarballs

- package.json: https://registry.npmjs.org/tsx/-/tsx-4.21.0.tgz
- tools/eval/package.json: https://registry.npmjs.org/tsx/-/tsx-4.21.0.tgz

## Lifecycle And Native/Binary Review

Executes the tsx CLI in maintainer workflows; transitive esbuild has install-time native binary selection.
