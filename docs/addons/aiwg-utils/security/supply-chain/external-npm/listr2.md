...
|---|---|
| Package | `listr2` |
| Canonical upstream repository | https://github.com/listr2/listr2.git |
| Audited version/ref | `8.3.3` / `8.3.3` |
| npm registry signatures | 1 |
| Dependency source summary | `cli-truncate`, `colorette`, `log-update`, `rfdc`, `wrap-ansi` |
| Optional dependency summary | (none) |
| Peer dependency summary | (none) |
| Provenance record path | `.aiwg/security/supply-chain/external-npm/listr2.md` |

## AIWG Usage Contexts

| Manifest | Field | Spec | Lockfile Version | Integrity | Install Script | Optional Lock Entry | Tracking |
|---|---|---:|---:|---|---|---|---|
| `package.json` | `dependencies` | `^8.2.5` | `8.3.3` | yes | no | no | #1444 |

## Lockfile Tarballs

- package.json: https://registry.npmjs.org/listr2/-/listr2-8.3.3.tgz
