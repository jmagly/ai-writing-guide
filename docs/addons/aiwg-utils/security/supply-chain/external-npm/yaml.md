...
|---|---|
| Package | `yaml` |
| Canonical upstream repository | https://github.com/eemeli/yaml.git |
| Audited version/ref | `2.8.2` / `2.8.2` |
| npm registry signatures | 1 |
| Dependency source summary | (none) |
| Optional dependency summary | (none) |
| Peer dependency summary | (none) |
| Provenance record path | `.aiwg/security/supply-chain/external-npm/yaml.md` |

## AIWG Usage Contexts

| Manifest | Field | Spec | Lockfile Version | Integrity | Install Script | Optional Lock Entry | Tracking |
|---|---|---:|---:|---|---|---|---|
| `package.json` | `dependencies` | `^2.8.1` | `2.8.2` | yes | no | no | #1444 |

## Lockfile Tarballs

- package.json: https://registry.npmjs.org/yaml/-/yaml-2.8.2.tgz
