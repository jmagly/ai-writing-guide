...
|---|---|
| Package | `ora` |
| Canonical upstream repository | https://github.com/sindresorhus/ora.git |
| Audited version/ref | `5.4.1` / `5.4.1` |
| npm registry signatures | 1 |
| Dependency source summary | `chalk`, `cli-cursor`, `cli-spinners`, `is-interactive`, `log-symbols`, `strip-ansi`, `wcwidth` |
| Optional dependency summary | (none) |
| Peer dependency summary | (none) |
| Provenance record path | `.aiwg/security/supply-chain/external-npm/ora.md` |

## AIWG Usage Contexts

| Manifest | Field | Spec | Lockfile Version | Integrity | Install Script | Optional Lock Entry | Tracking |
|---|---|---:|---:|---|---|---|---|
| `package.json` | `dependencies` | `^5.4.1` | `5.4.1` | yes | no | no | #1444 |

## Lockfile Tarballs

- package.json: https://registry.npmjs.org/ora/-/ora-5.4.1.tgz
