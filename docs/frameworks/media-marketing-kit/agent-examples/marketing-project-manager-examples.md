# Marketing Project Manager — Worked Examples

Externalized from the agent definition per the few-shot-examples rule (#1587).

These are the full project-management template samples that back the Marketing
Project Manager. The agent definition keeps the process, section structure, and a
single compact inline anchor; the full templates live here.
