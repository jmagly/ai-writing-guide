...
```bash
aiwg use all --provider codex --copy-all
```
...
Questions and field reports are welcome in the
[AIWG 2026.8.19 release discussion](https://github.com/jmagly/aiwg/discussions/159).
