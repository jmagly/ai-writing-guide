...
Seven verdicts from [ADR #1041](../../.aiwg/architecture/adr-override-shadow-policy.md):
...
### Identical-form portability ([ADR #1038](../../.aiwg/architecture/adr-identical-form-portability.md))
...
| [`examples/project-local/README.md`](../../examples/project-local/README.md) | Working example via `aiwg new-bundle` |
