...
Published in [`SECURITY.md`](https://github.com/jmagly/aiwg/blob/main/SECURITY.md) and [`.gitea/keys/maintainers.asc`](https://git.integrolabs.net/roctinam/aiwg/src/branch/main/.gitea/keys/maintainers.asc).
...
- **Containers**: `node:24@sha256:050bf2b...` (publishing leg) and `node:20@sha256:8f693ea...` (everything else). Manifest in [`ci/digests.txt`](https://github.com/jmagly/aiwg/blob/main/ci/digests.txt).
...
Full risk-closure table and the corresponding control map are in [`.aiwg/security/supply-chain-postmortem-2026-05.md`](https://github.com/jmagly/aiwg/blob/main/.aiwg/security/supply-chain-postmortem-2026-05.md).
...
- [`CHANGELOG.md`](https://github.com/jmagly/aiwg/blob/main/CHANGELOG.md) — full release detail
...
- [`SECURITY.md`](https://github.com/jmagly/aiwg/blob/main/SECURITY.md) — maintainer key fingerprint, vulnerability disclosure
- [`ci/digests.txt`](https://github.com/jmagly/aiwg/blob/main/ci/digests.txt) — CI pin manifest
