...
- **115 specialized agents** covering all lifecycle phases (Inception → Elaboration → Construction → Transition → Production)
- **305 skills** for project management, security, testing, deployment, and traceability
