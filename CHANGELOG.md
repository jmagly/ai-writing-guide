...
> Targeting **2026.5.0** stable. The 2026.4.0 stable tag was never cut — the rc series stopped at `v2026.4.0-rc.33` and rolled forward to `v2026.5.0-rc.1`. Everything from both rc lines is folded into 2026.5.0 stable. There is no `v2026.4.0` git tag and `npm install aiwg@2026.4.0` will not resolve.
