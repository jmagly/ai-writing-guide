...
export const helpCommand: Extension = {
  ...
  type: 'command',
  name: 'Help',
  description: 'Display comprehensive CLI help information',
  version: '1.0.0',
...
export const useCommand: Extension = {
  ...
  type: 'command',
  name: 'Use',
  description: 'Install and deploy framework (sdlc, marketing, writing, all)',
  version: '1.0.0',
...
export const newCommand: Extension = {
  ...
  type: 'command',
  name: 'New Project',
  description: 'Create new project with SDLC templates',
  version: '1.0.0',
...
export const runtimeInfoCommand: Extension = {
  ...
  type: 'command',
  name: 'Runtime Info',
  description: 'Show runtime environment summary with tool discovery',
  version: '1.0.0',
...
export const prefillCardsCommand: Extension = {
  ...
  type: 'command',
  name: 'Prefill Cards',
  description: 'Prefill SDLC card metadata from team profile',
  version: '1.0.0',
...
export const contributeStartCommand: Extension = {
  ...
  description: 'Start AIWG contribution workflow',
  version: '1.0.0',
...
export const validateMetadataCommand: Extension = {
  ...
  description: 'Validate plugin/agent metadata',
  version: '1.0.0',
...
export const packagePluginCommand: Extension = {
  ...
  type: 'command',
  name: 'Package Plugin',
  description: 'Package specific plugin for Claude Code marketplace',
  version: '1.0.0',
...
export const packageAllPluginsCommand: Extension = {
  ...
  description: 'Package all plugins for Claude Code marketplace',
  version: '1.0.0',
  capabilities: ['cli', 'plugin', 'packaging'],
