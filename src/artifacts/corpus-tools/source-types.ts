...
export const DEFAULT_SOURCE_TYPES: SourceTypeRegistry = {
  ...
  types: {
    ...
    'expert-material': { description: 'Expert commentary, talk, or interview material.', aliases: ['expert-material', 'expert material', 'talk', 'interview', 'keynote'], template: 'reference-web', requiredSections: ['Citation', 'Summary', 'Key Claim'], citationFormat: 'url-venue-retrieved', acquisition: 'manual', storage: 'sources/web', qualityRules: 'expert-opinion-hedging', defaultRadarCadence: 'on-demand' },
