# node-pty External NPM Supply-Chain Audit
...
|---|---|
| Package | `node-pty` |
| Canonical upstream repository | https://github.com/microsoft/node-pty.git |
| Audited version/ref | `1.1.0` / `1.1.0` |
| npm registry signatures | 1 |
| Dependency source summary | `node-addon-api` |
| Optional dependency summary | (none) |
| Peer dependency summary | (none) |
| Provenance record path | `.aiwg/security/supply-chain/external-npm/node-pty.md` |

## AIWG Usage Contexts

| Manifest | Field | Spec | Lockfile Version | Integrity | Install Script | Optional Lock Entry | Tracking |
|---|---|---:|---:|---|---|---|---|
| `package.json` | `optionalDependencies` | `^1.0.0` | `1.1.0` | yes | yes | yes | #1445 |

## Lockfile Tarballs

- package.json: https://registry.npmjs.org/node-pty/-/node-pty-1.1.0.tgz

## Lifecycle And Native/Binary Review

Native PTY addon. Consumer install may execute prebuild lookup and node-gyp fallback plus postinstall script.
