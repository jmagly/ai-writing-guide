...
| Review before construction | Control FAILED in execution: construction landed 2026-07-10 while the approval record was still PENDING (risk R-LFD-010 occurred). The operator granted retroactive approval with revisions on 2026-07-11 — see `.aiwg/planning/issue-1585-operator-approval-record.md` and `.aiwg/reports/lfd-cycle-audit-2026-07-11.md` | WAIVED (2026-07-11) |
